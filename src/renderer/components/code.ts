...
const renderCodeBlock = (
    ...
    doc.roundedRect(cursor.x, cursor.y - options.page.lineSpace, options.page.maxContentWidth, totalHeight, 2, 2, "FD")
    doc.setFontSize(10)
    doc.text(element.lang ?? '', cursor.x + options.page.maxContentWidth - doc.getTextWidth(element.lang ?? '') - options.page.lineSpace / 2, cursor.y)
