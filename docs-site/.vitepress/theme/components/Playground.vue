        ...
        <div class="playground-preview">
          <div class="pane-header">
            ...
            <div class="pane-actions">
              ...
              <button class="btn btn-secondary" @click="downloadPDF" :disabled="!pdfBlobUrl">
                Download
              </button>
            </div>
          </div>
          <div class="preview-frame">
            ...
            <div v-else class="preview-placeholder">
              <div class="placeholder-content">
                ...
                <p>Click <strong>Generate PDF</strong> to see your preview</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div v-if="!hideOptions" class="playground-options">
        ...
        <div class="options-grid">
          <div class="option-group">
            <label>Font Size <span class="option-val">{{ opts.defaultFontSize }}pt</span></label>
            <input type="range" v-model.number="opts.defaultFontSize" min="8" max="24" step="1" />
          </div>
          <div class="option-group">
            <label>Title Font Size <span class="option-val">{{ opts.defaultTitleFontSize }}pt</span></label>
            <input type="range" v-model.number="opts.defaultTitleFontSize" min="10" max="30" step="1" />
          </div>
          <div class="option-group">
            <label>Line Spacing <span class="option-val">{{ opts.lineSpace }}</span></label>
            <input type="range" v-model.number="opts.lineSpace" min="1" max="10" step="0.5" />
          </div>
          <div class="option-group">
            <label>X Padding <span class="option-val">{{ opts.xpading }}mm</span></label>
            <input type="range" v-model.number="opts.xpading" min="5" max="40" step="1" />
          </div>
          <div class="option-group">
            <label>Top Margin <span class="option-val">{{ opts.topmargin }}mm</span></label>
            <input type="range" v-model.number="opts.topmargin" min="5" max="40" step="1" />
          </div>
          <div class="option-group">
            <label>Indent <span class="option-val">{{ opts.indent }}mm</span></label>
            <input type="range" v-model.number="opts.indent" min="4" max="20" step="1" />
          </div>
          <div class="option-group">
